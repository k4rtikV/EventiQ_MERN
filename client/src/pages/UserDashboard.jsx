...
const UserDashboard = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto">
            <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 mb-8 border border-gray-100 flex flex-col sm:flex-row sm:items-center text-center sm:text-left gap-6">
                ...
                <div className="w-full sm:w-auto sm:ml-auto flex flex-col gap-2.5">
                    ...
                    <Link
                        to="/wishlist"
                        className="inline-flex items-center justify-center gap-2 bg-white hover:bg-red-50 border border-red-200 text-red-600 font-semibold py-2.5 px-5 rounded-lg transition"
                    >
                        <FaHeart />
                        My Wishlist
                    </Link>
                                      ...
                                      booking.status ===
                                        ...
                                        <>
                                            ...
                                            'paid' ? (
                                                ...
                                                <button
                                                    type="button"
                                                    className="w-full bg-gray-200 text-gray-500 rounded-xl px-4 py-3 font-semibold cursor-not-allowed"
                                                    disabled
                                                >
                                                    Ticket pending
                                                    approval
