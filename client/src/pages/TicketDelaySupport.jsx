...
I successfully completed payment for "${data.eventId?.title || 'my event'}", but my booking is still showing as paid and pending approval, and my ticket has not yet been assigned.
...
Please verify my payment and assign the ticket as soon as possible.
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const {
                ...
                `/support/ticket-delay/${bookingId}`,
                {
                    message
                }
            );
            ...
            <div className="grid md:grid-cols-2 gap-8 items-start">
                <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
                        Use this form when your payment is
                        complete but the admin has not yet
                        approved your booking and assigned
                        your ticket.
                    </p>
                            ...
                            >
                                {submitting ? (
                                    ...
                                    <>
                                        ...
                                        Send delay request with invoice
                                    </>
                                )}
                            </button>
...
export default TicketDelaySupport;