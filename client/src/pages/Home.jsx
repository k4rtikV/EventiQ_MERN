    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <div className="relative bg-black text-white rounded-3xl overflow-hidden mb-12 shadow-2xl">
                <div className="absolute inset-0 opacity-40 bg-[url('https://images.unsplash.com/photo-1459749411175-04bf5292ceea?q=80&w=3000&auto=format&fit=crop')] bg-cover bg-center" />
                ...
                <div className="relative p-10 md:p-20 text-center flex flex-col items-center z-10">
                    ...
                    <p className="text-gray-300 text-lg md:text-xl mb-10 max-w-2xl mx-auto font-light leading-relaxed">
                        Discover the best tech conferences, late-night
                        music festivals, and hands-on workshops happening
                        directly in your area. Secure your spot today.
                    </p>
            ...
            {loading ? (
                ...
                <>
                    ...
                    <div className="flex justify-center mt-12 mb-4">
                        <Link
                            to="/events"
                            className="inline-flex items-center justify-center gap-3 bg-gray-900 hover:bg-black text-white font-semibold px-8 py-3 rounded-xl shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300"
                        >
                            View All Events
                            <span
                                aria-hidden="true"
            ...
            <footer className="mt-auto pt-16 pb-8 border-t border-gray-200 text-center">
                ...
                <div className="text-xs text-gray-400 font-medium uppercase tracking-wider">
                    &copy; {new Date().getFullYear()} EventiQ Platform.
                    All rights reserved.
                </div>
            </footer>
        </div>
